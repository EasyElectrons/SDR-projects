...
class nfm_rx_no_atan(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "nfm_rx_no_atan")
        ...
        # Blocks
        ##################################################
        self._vol_range = Range(0, 5, .1, 1, 200)
        ...
        self._squelch_range = Range(-70, 0, 1, -55, 200)
        ...
        self.rtlsdr_source_0.set_sample_rate(samp_rate*10)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.epy_block_0 = epy_block_0.blk(scale=1)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/student/grc/nfm_rx_no_atan/nfm_rx_no_atan.wav', 1, 48000, 8)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(vol)
        self.audio_sink_0 = audio.sink(48000, '', True)
        self.analog_simple_squelch_cc_0 = analog.simple_squelch_cc(squelch, 75e-6)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_simple_squelch_cc_0, 0), (self.epy_block_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 25e3, 2.5e3, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 5e3, 500, firdes.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.rtlsdr_source_0.set_sample_rate(self.samp_rate*10)





def main(top_block_cls=nfm_rx_no_atan, options=None):
